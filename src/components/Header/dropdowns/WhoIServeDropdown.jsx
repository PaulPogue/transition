...
const WhoIServeDropdown = () => (
  <div className="p-4">
    <h3 className="text-gray-800 font-semibold">Individuals</h3>
    ...
    <h3 className="text-gray-800 font-semibold mt-4">Businesses</h3>
    <ul className="space-y-1">
      <li>
        <a
...
export default WhoIServeDropdown;
